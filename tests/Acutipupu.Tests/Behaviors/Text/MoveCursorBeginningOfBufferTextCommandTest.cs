...
public class MoveCursorBeginningOfBufferTextCommandTest : TextCommandTest
{
    private readonly Entry _component;
    private readonly MoveCursorBeginningOfBufferTextCommand _command;

    public MoveCursorBeginningOfBufferTextCommandTest()
    {
