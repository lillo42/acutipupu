...
public class MoveScreenHalfPageUpEntryCommandTest : EntryCommandTest
{
    private readonly MoveScreenHalfPageUpEntryCommand _command;
    private readonly Acutipupu.Components.Entry _component = new();

    public MoveScreenHalfPageUpEntryCommandTest()
    {
