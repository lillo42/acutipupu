...
public class MoveScreenPageUpEntryCommandTest : EntryCommandTest
{    
    private readonly MoveScreenPageUpEntryCommand _command;
    private readonly Acutipupu.Components.Entry _component;

    public MoveScreenPageUpEntryCommandTest()
    {
