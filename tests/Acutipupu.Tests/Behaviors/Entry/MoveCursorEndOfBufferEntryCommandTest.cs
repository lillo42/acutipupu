...
public class MoveCursorEndOfBufferEntryCommandTest : EntryCommandTest
{
    private readonly Acutipupu.Components.Entry _component;
    private readonly MoveCursorEndOfBufferEntryCommand _command;

    public MoveCursorEndOfBufferEntryCommandTest()
    {
