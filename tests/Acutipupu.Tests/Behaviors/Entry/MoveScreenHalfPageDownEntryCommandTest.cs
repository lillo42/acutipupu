...
public class MoveScreenHalfPageDownEntryCommandTest : EntryCommandTest
{
    private readonly MoveScreenHalfPageDownEntryCommand _command;
    private readonly Acutipupu.Components.Entry _component;

    public MoveScreenHalfPageDownEntryCommandTest()
    {
    ...
    [InlineData(LoremIpsum, 1,
        ...
        0, 12,
        12, 0)]
    [InlineData(LoremIpsum, 2,
        0, 10, 5, 5,
        0, 0,
        10, 0,
        0, 14,
        14, 0)]
    [InlineData(LoremIpsum, 20,
        0, 10, 5, 5,
        0, 0,
        0, 0,
        0, 18,
        ...
        int expectedCursorPositionRow, int expectedCursorPositionColumn)
    {
        ...
        var margin = new Margin(marginVertical, marginHorizontal);
