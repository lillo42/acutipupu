...
public class MoveScreenPageDownEntryCommandTest : EntryCommandTest
{    
    private readonly MoveScreenPageDownEntryCommand _command;
    private readonly Acutipupu.Components.Entry _component;

    public MoveScreenPageDownEntryCommandTest()
    {
