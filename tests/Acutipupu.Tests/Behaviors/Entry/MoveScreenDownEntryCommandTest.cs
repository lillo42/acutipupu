...
public class MoveScreenDownEntryCommandTest : EntryCommandTest
{
    private readonly MoveScreenDownEntryCommand _command;
    private readonly Acutipupu.Components.Entry _component;

    public MoveScreenDownEntryCommandTest()
    {
        var options = Substitute.For<IOptionsMonitor<AcutipupuAppOptions>>();
        var lastTextColumn = Substitute.For<ILastTextColumn>();
        lastTextColumn.LastColumn(Arg.Any<int>())
            .Returns(call => call.Arg<int>());
    ...
    public static IEnumerable<object[]> Data
    {
        get
        {
            ...
            {
                LoremIpsum, 1, new Rect(0, 0, 20, 20), new Margin(0, 0), new CursorPosition(0, 0),
                new CursorPosition(1, 0), new Rect(0, 1, 20, 20)
            };

            yield return new object[]
            {
                LoremIpsum, 2, new Rect(0, 0, 20, 20), new Margin(0, 0), new CursorPosition(10, 0),
                new CursorPosition(10, 0), new Rect(0, 2, 20, 20)
            };

            yield return new object[]
            {
                LoremIpsum, 5, new Rect(0, 0, 20, 20), new Margin(0, 0), new CursorPosition(0, 0),
                new CursorPosition(5, 0), new Rect(0, 5, 20, 20)
            };

            yield return new object[]
            {
                LoremIpsum, 1, new Rect(0, 0, 20, 20), new Margin(1, 0), new CursorPosition(0, 0),
                new CursorPosition(2, 0), new Rect(0, 1, 20, 20)
            };

            yield return new object[]
            {
                LoremIpsum, 1, new Rect(0, 0, 20, 20), new Margin(5, 0), new CursorPosition(0, 0),
                new CursorPosition(6, 0), new Rect(0, 1, 20, 20)
            };

            yield return new object[]
            {
                LoremIpsum, 3, new Rect(0, 0, 20, 20), new Margin(5, 0), new CursorPosition(0, 0),
                new CursorPosition(8, 0), new Rect(0, 3, 20, 20)
            };

            yield return new object[]
            {
                LoremIpsum, 20, new Rect(0, 0, 20, 20), new Margin(0, 0), new CursorPosition(0, 0),
                new CursorPosition(18, 0), new Rect(0, 18, 20, 20)
            };

            yield return new object[]
            {
                LoremIpsum, 20, new Rect(0, 0, 20, 20), new Margin(10, 0), new CursorPosition(0, 0),
                new CursorPosition(18, 0), new Rect(0, 18, 20, 20)
            };
            yield return new object[]
            {
                LoremIpsum, 2, new Rect(0, 0, 2, 2), new Margin(1, 0), new CursorPosition(0, 0),
                new CursorPosition(2, 0), new Rect(0, 2, 2, 2)
            };
        }
    }
    ...
    public async Task OnExecute(string text, int movement,
        Rect screenArea, Margin margin, CursorPosition cursorPosition,
        CursorPosition expectedCursorPosition, Rect expectedScreenArea)
    {
        _component
            .SetText(text)
        ...
        _component.CursorPosition.Should().Be(expectedCursorPosition);
        _component.ScreenArea.Should().Be(expectedScreenArea);
    }
}
