...
/// </summary>
public abstract class MoveCursorPreviousOccurenceInCurrentLineTextCommand : TextCommand
{
    /// <summary>
    ...
    protected MoveCursorPreviousOccurenceInCurrentLineTextCommand(IComponentAccessor accessor,
    ...
    /// <inheritdoc/>
    protected override KeyBindingCollection GetKey(TextKeyMap map) => map.NextCharOccurence;
