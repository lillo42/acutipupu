...
/// </summary>
public abstract class MoveCursorNextOccurenceInCurrentLineEntryCommand : EntryCommand
{
    /// <summary>
    ...
    protected MoveCursorNextOccurenceInCurrentLineEntryCommand(IComponentAccessor accessor,
