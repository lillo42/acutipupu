...
/// <summary>
/// Move screen page down.
/// </summary>
public class MoveScreenPageDownEntryCommand : EntryCommand
{
    private readonly ILastTextColumn _lastTextColumn;

    /// <summary>
    /// Initializes a new instance of the <see cref="MoveScreenPageDownEntryCommand"/> class.
    /// </summary>
    ...
    public MoveScreenPageDownEntryCommand(IComponentAccessor accessor,
    ...
    protected override void OnExecute(ImmutableList<KeyMessage> keys, Components.Entry entry)
    {
        ...
        {
            Y = Math.Min(entry.ScreenArea.Y + number * entry.ScreenArea.Height, indexes.Count - 1)
        };
