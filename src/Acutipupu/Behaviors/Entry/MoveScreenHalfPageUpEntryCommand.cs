...
/// <summary>
/// Move screen half page up.
/// </summary>
public class MoveScreenHalfPageUpEntryCommand : EntryCommand
{
    private readonly ILastTextColumn _lastTextColumn;

    /// <summary>
    /// Initializes a new instance of the <see cref="MoveScreenHalfPageUpEntryCommand"/> class.
    /// </summary>
    ...
    public MoveScreenHalfPageUpEntryCommand(IComponentAccessor accessor,
    ...
    protected override void OnExecute(ImmutableList<KeyMessage> keys, Components.Entry entry)
    {
        ...
        var screenArea = entry.ScreenArea with { Y = Math.Max(entry.ScreenArea.Y - number * (entry.ScreenArea.Height / 2), 0) };
